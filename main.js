...
function playpause() {
  ...
  function visualmode(){
    ...
    document.querySelector('.python-dev-heading').classList.toggle('heading-article-light');
    ...
    document.getElementById('ML').classList.toggle('language-gradient-class');
    document.getElementById('datascience').classList.toggle('language-gradient-class');
...
console.log('%c Designed and Developed by Dhaval Pawar  ', 'background-image: linear-gradient(90deg,#8000ff,#6bc5f8); color: white;font-weight:900;font-size:1rem; padding:20px;');
